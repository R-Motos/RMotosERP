...
interface CouponFiltersProps {
  filters: CuponFilter
  onFilterChange: (key: keyof CuponFilter, value: unknown) => void
  onClear: () => void
}

export function CouponFilters({ filters, onFilterChange, onClear }: CouponFiltersProps) {
  ...
  const handleEstadoChange = useCallback((e: React.ChangeEvent<HTMLSelectElement>) => {
    onFilterChange('estado', (e.target.value as CuponFilter['estado']) || undefined)
  }, [onFilterChange])
